...
export class SteamController {
    ...
    async waitForServicesToInitialize(): Promise<boolean> {
        ...
        return (
            (await (window as WindowEx).App?.WaitForServicesInitialized?.().then((success: boolean) => {
    ...
    registerForOnResumeFromSuspend(callback: () => void): Unregisterer {
        const register =
            SteamClient.System.RegisterForOnResumeFromSuspend?.bind(SteamClient.System) ??
