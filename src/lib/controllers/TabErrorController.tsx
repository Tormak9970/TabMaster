...
export class TabErrorController {
     ...
     */
    private static validateInternal(
        validationSet: { tabId: string; rebuildCollectionIfValid?: boolean }[],
     ...
     */
    static validateSettingsOnLoad(
        tabsSettings: TabSettingsDictionary,
        tabMasterManager: TabMasterManager,
        finishLoading: (editedTabSettings: TabSettingsDictionary) => void
    ) {
     ...
     */
    static validateTabs(
        tabIdsToValidate: string[],
        tabMasterManager: TabMasterManager,
        rebuildValidTabCollections?: boolean
    ) {
