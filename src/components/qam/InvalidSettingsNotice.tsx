            ...
            <Field
                description={
                    <div style={{ margin: '8px', fontSize: '12px' }}>
                        ...
                        <div>
                            The settings file does not adhere to the expected structure and could not be loaded. This
                            could be due to various reasons such as a change in Steam or a bug in TabMaster. In order to
                            continue the issue must be corrected or alternatively you can reset the tab settings to
                            default. This will erase all settings, but a copy of the current settings will automatically
                            be saved as a backup. A future TabMaster update may be able to correct the issue, however
                            manually restoring the backup will still be necessary.
                        </div>
                        {children}
