...
export const FiltersPanel: VFC<FiltersPanelProps> = ({
    groupFilters,
    groupLogicMode,
    setGroupFilters,
    setGroupLogicMode,
                    ...
                    >
                        <div style={{ width: '100px' }}>
                            <Dropdown
                                ...
                                selectedOption={groupLogicMode}
                                onChange={option => setGroupLogicMode(option.data)}
                                focusable={true}
                            />
                        </div>
                    </Field>
                    ...
                    <div className='styled-btn no-sep'>
                        {!canAddFilter ? (
                            <div style={{ marginTop: '10px' }}>
                                Please finish the current filter before adding another
                            </div>
                        ) : (
                            <Fragment />
                        )}
