 ...
 */
export const FilterEntry: VFC<FilterEntryProps> = ({
    index,
    filter,
    ...
    if (filter) {
        const filterTypeDropdownElt = (
            <Focusable
                style={!canBeInverted(filter) ? { width: 'calc(100% - 55px)' } : { width: 'calc(100% - 185px)' }}
            >
